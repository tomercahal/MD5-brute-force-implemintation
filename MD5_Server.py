...
class Server (object):
    def __init__(self):
        ...
        self.START_NUM = 3735708558  # The number that the hash starts with
    ...
    def handle_thread(self, client_sock, thread_num):
        ...
        self.send_to_client(client_sock, thread_num)
    ...
    def send_to_client(self, client_socket, thread_num):
        ...
        while found and self.START_NUM < self.FINISH_NUM:  # While no client found the md5 hash value or max num
